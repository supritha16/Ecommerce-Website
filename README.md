...
2.Product Catalog: MyStore offers a wide range of products categorized into various sections for easy navigation. Users can browse products, view detailed descriptions, and add items to their cart.
...
3.Profile Management: Users can edit their profile information such as name, email, and address. Additionally, users have the option to delete their account if needed.
...
4.Shopping Cart: The website features a cart system that allows users to add products, adjust quantities, and remove items before proceeding to checkout.
...
5.Payment Options at Checkout:MyStore now offers users the flexibility to choose between online and offline payment methods at the checkout stage.
Upon clicking the "Checkout" button, users are directed to a payment page where they can select their preferred payment option: Pay Online or Pay Offline.
If the user selects the "Pay Online" option, MyStore redirects them to the PayPal website for secure online payment processing.
...
6.Display Total Price in Shopping Cart:MyStore now calculates and displays the total price of items in the shopping cart, providing users with a transparent overview of their order's cost.
As users add or remove items from their cart, the total price dynamically updates to reflect the changes.
...
7.Payment Options at Checkout:
MyStore now offers users the flexibility to choose between online and offline payment methods at the checkout stage.
Upon clicking the "Checkout" button, users are directed to a payment page where they can select their preferred payment option: Pay Online or Pay Offline.
If the user selects the "Pay Online" option, MyStore redirects them to the PayPal website for secure online payment processing.
If the user selects the "Pay Offline" option, MyStore redirects them back to the home page.

<img width="700" alt="Screenshot 2024-03-16 235125" src="https://github.com/supritha16/Ecommerce-Website/assets/99244765/886cb725-df15-4ae6-bea9-0a945a07a7cc">


8.Search Functionality:MyStore includes a search feature that allows users to quickly find products by entering keywords or product names.
...
9.Display Stock Availability Message for Categories:MyStore now includes a feature that dynamically checks the availability of products within a category.
...
10.View More: Display Related Images of Products:MyStore introduces a "View More" feature that enhances the product browsing experience by displaying related images of each product.
...
1.Admin Panel: Administrators have access to an exclusive admin panel where they can manage products, view orders, and update the website's content.
...
2.Insert Products:Administrators have the capability to add new products to the MyStore database directly from the admin panel.
The "Insert Products" feature includes fields for product name, description, price, category, brand, and images.
...
3.View Products:Administrators can view a comprehensive list of all products available on MyStore.
...
4.Insert Categories:MyStore allows administrators to add new product categories through the admin panel.
...
5.Insert Brands:Administrators can add new brands or manufacturers to the MyStore database via the admin panel.
...
6.List Users:MyStore's admin panel includes a feature to list all registered users of the website.
...
3.Database Setup:Import the mystore.sql file into your MySQL database to create the necessary tables.
...
4.Run the Application:Start your web server.
